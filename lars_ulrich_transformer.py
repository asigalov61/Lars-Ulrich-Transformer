...
Original file is located at
    https://colab.research.google.com/drive/1NSpsG3UmpAzJcBd_H0yqaKjrPLJC7QAG

# Lars Ulrich Transformer (ver. 4.0)
...
#@markdown Generation settings
melody_instrument = "Piano" #@param ["Piano", "Guitar", "Bass", "Violin", "Cello", "Organ", "Trumpet", "Sax", "Flute"]
number_of_chords_to_generate = 100 # @param {type:"slider", min:10, max:1000, step:1}
...
#@title Stabilized Auto-Continuation
...
def generate_chord(input_seq, number_of_memory_tokens, temperature):
  ...
  return oseq, chord, chord_tones, oseq1
...
while generated_chords_count < number_of_chords_to_generate:
  ...
  try:
    ...
    if (data[2] in chords_tones) and (data[3] not in pchords):
      outy.extend(data[0])
      pchords.append(data[3])
