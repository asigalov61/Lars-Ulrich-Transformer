...
Original file is located at
    https://colab.research.google.com/drive/1_79xpw3EKaBRuqvy6TVV65FCIU2N1UDi

# Lars Ulrich Transformer Composer (ver. 1.0)
...
number_of_prime_tokens = 400 #@param {type:"slider", min:64, max:2045, step:5}
...
number_of_memory_tokens = 400 #@param {type:"slider", min:400, max:2045, step:5}
temperature = 0.9 #@param {type:"slider", min:0.1, max:1, step:0.1}
render_MIDI_to_audio = False #@param {type:"boolean"}

print('=' * 70)
print('Lars Ulrich Standard Model Generator')
print('=' * 70)
...
block_action = "remove_last_added_block" #@param ["add_last_generated_block", "remove_last_added_block"]
...
if block_action == 'add_last_generated_block':
  ...
  if len(melody_chords_f) > 400 and len(block_lines) > 1:
    melody_chords_f = melody_chords_f[:(len(melody_chords_f)-400)]
    print('Block removed!')
  else:
