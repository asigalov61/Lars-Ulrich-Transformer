...
# Lars Ulrich Transformer Composer (ver. 3.0)
...
number_of_prime_tokens = 500 # @param {type:"slider", min:30, max:5000, step:5}
...
number_of_tokens_to_generate = 250 # @param {type:"slider", min:30, max:1025, step:5}
