...
# Lars Ulrich Transformer Composer (ver. 2.0)
...
number_of_prime_tokens = 210 # @param {type:"slider", min:65, max:2045, step:5}
...
number_of_tokens_to_generate = 120 # @param {type:"slider", min:30, max:1025, step:5}
